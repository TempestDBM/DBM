    ...
    action: function(cache) {
        ...
        switch (INTO) {
                ...
                case 7:
                    ...
                    break;
                    case 8:
                    if(isNaN(parseInt(theVar.toString().replace(",", ".")))) {
                        result = theVar;
                    } else {
                        result = parseInt(theVar.toString().replace(",", ".")).toLocaleString("pt-BR");
                    }
                    break;
                    case 9:
                    var number = parseInt((this.evalMessage(theVar, cache)).toString().replace(",", "."));
                    ...
                    case 13:
                        ...
                        var palavra = theVar.toString();
    
                        for(var i = 0; i <= comAcentos.length; i++) {
                            palavra = palavra.replaceAll(comAcentos[i], semAcentos[i]);
                        }
