module.exports = {
    ...
    variableStorage: function(data, varType) {
        ...
        const info2 = ['Number', 'Number', 'Number', 'String', 'String', 'String', 'String', 'String', 'String', 'String', 'String', 'String', 'String', 'String', 'String'];
    ...
    action: function(cache) {
        ...
        switch (INTO) {
                ...
                case 7:
                    ...
                    break;
                    case 8:
                    result = parseInt(theVar).toLocaleString("pt-BR");
                    break;
                    case 9:
