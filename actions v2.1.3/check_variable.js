module.exports = {
  ...
  html(isEvent, data) {
    return `
<span>Ação modificada por: Tempest#8741</span><br><br>
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
      ...
      <option value="14">Diferente de</option>
    ...
    switch (compare) {
      ...
      case 5:
        ...
        case 9:
          ...
          break;
        case 10:
          result = val1.toString().startsWith(val2.toString());
          break;
        case 11:
          result = val1.toString().endsWith(val2.toString());
          break;
        case 12:
